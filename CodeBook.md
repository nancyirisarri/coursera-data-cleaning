...
Table Structure 
===============
Columns 1 to 79 contain the means, which have been renamed to make more human readable:
```
...
Rows 1 to 6 are for each of the activity types. Rows 7 to 36 are for each of the subjects:
```
